...
export const LECTURE_STUDIO_AUTHORING_POLICY_VERSION = 3 as const;
...
Emit only the bounded LaTeX dialect supported by GOSU. Both bodies may use itemize, enumerate, description, center, quote, equation/equation*, align/align*, gather/gather*, multline/multline*, tabular, and math-nested aligned, alignedat, gathered, split, cases, array, matrix, pmatrix, bmatrix, Bmatrix, vmatrix, Vmatrix, or smallmatrix environments. Notes may additionally use theorem, proposition, lemma, definition, remark, example, proof, and longtable. Slides may additionally use block, alertblock, columns, and column inside a frame. Common AMS symbols and operators such as \\binom, \\mid, \\Vert, \\lVert, \\rVert, \\langle, \\rangle, \\pmod, and \\operatorname are supported. Do not use \\( ... \\), \\[ ... \\], custom commands, package-dependent graphics, citations such as \\cite, or any environment not named here.
