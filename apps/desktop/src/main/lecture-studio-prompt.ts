...
export const LECTURE_STUDIO_AUTHORING_POLICY_VERSION = 4 as const;
...
Emit only the bounded LaTeX dialect supported by GOSU. Both bodies may use itemize, enumerate, description, center, flushleft, flushright, quote, minipage, table, tabular, displaymath, equation/equation*, align/align*, gather/gather*, multline/multline*, and math-nested aligned, alignedat, gathered, split, cases, array, matrix, pmatrix, bmatrix, Bmatrix, vmatrix, Vmatrix, or smallmatrix environments. Notes may additionally use abstract, theorem, proposition, lemma, definition, remark, example, proof, longtable, and table*. Slides may additionally use block, alertblock, columns, and column inside a frame. Inline math may use balanced $...$ or \\(...\\); display math may use balanced $$...$$, \\[...\\], or a named math environment, but never nest or mix delimiter styles. Common AMS symbols, operators, and helpers such as \\binom, \\boxed, \\mid, \\|, \\Vert, \\lVert, \\rVert, \\langle, \\rangle, \\pmod, \\operatorname, \\tag, \\notag, \\nonumber, and \\intertext are supported. Tables may use \\hline, \\cline, and the loaded booktabs commands \\toprule, \\midrule, \\bottomrule, \\cmidrule, and \\addlinespace. Do not use custom commands, package-dependent graphics, citations such as \\cite, or any environment not named here. Expand source-defined macros into this bounded dialect instead of copying their definitions or calls.
